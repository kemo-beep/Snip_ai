...
export default function SimpleTimeline({
    ...
    // Create timeline data with proper structure - ALWAYS show both tracks
    ...
    const effects: Record<string, TimelineEffect> = useMemo(() => {
        ...
        console.log('Effects created:', effectsMap)
        return effectsMap
    }, [clips])
    ...
    console.log('Rendering SimpleTimeline with data:', { timelineData, effects, clips })
